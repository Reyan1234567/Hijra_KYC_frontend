...
const DetailReport: React.FC = () => {
  ...
  const onFinish = async (values: any) => {
    ...
    try {
      ...
      if (statusValue !== 4 && statusValue !== null)
  ...
  return (
    <Card>
      ...
      <Form
        ...
        layout="vertical"
        onFinish={onFinish}
        initialValues={{ status: "4,All status", Branch: "0,ALL Branch,0" }}
      >
        <Row gutter={16}>
          <Col xs={24} md={10}>
            <Form.Item
          ...
          <Col xs={24} md={10}>
            <Form.Item name="status" label="Request Status">
              <Select>
                <Option value="4,All status">All Status</Option>
                <Option value="0,Pending">Pending</Option>
                <Option value="1,Approved">Approved</Option>
                <Option value="2,Rejected">Rejected</Option>
                <Option value="3,Saved">Saved</Option>
              </Select>
            </Form.Item>
          </Col>
        </Row>
